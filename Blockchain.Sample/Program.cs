...
namespace Blockchain.Sample
{
    ...
    public static class BlockChainExtension
    {
        ...
        public static bool IsValid(this IEnumerable<IBlock> items)
        {
            ...
            return enumerable
                .Zip(enumerable.Skip(1), Tuple.Create)
                .All(block => block.Item2.IsValid() && block.Item2.IsValidPrevBlock(block.Item1));
        }
    }
    class Program
    {
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < 200; i++)
            {
                ...
                Console.WriteLine($"Chan is valid : {chain.IsValid()}");
            }
